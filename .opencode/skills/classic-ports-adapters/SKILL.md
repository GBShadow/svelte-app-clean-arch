---
name: classic-ports-adapters
description: Guia (histórico) para implementar funcionalidades seguindo o padrão Ports & Adapters no app classic (Observable/Observer). Desde 2026-07-09 os apps classic e remote estão em deprecated/ — usar apenas como referência.
---
