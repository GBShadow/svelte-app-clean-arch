---
name: runes-ports-adapters
description: Guia para implementar novas funcionalidades seguindo o padrão Ports & Adapters no app runes (default) — domínio reativo, service, gateways, UI presentacional e containers.
---
