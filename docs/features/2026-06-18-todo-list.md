...
> **Nota (2026-07-09):** a lista global do app **runes** descrita aqui foi removida e substituída por múltiplas listas por usuário — ver [2026-07-09-pocketbase-todo-sharing.md](./2026-07-09-pocketbase-todo-sharing.md). Este documento continua valendo como referência histórica para **classic** e **remote** (agora em `deprecated/`), que não foram alterados.
