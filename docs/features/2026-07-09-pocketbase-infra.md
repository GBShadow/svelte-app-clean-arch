...
Nenhum app SvelteKit ainda consome o PocketBase — esta é só a camada de infraestrutura (spec [`pocketbase-auth`](../specs/2026-07-09-pocketbase-auth.md) cobre a integração).
