...
Com o backend PocketBase disponível ([`pocketbase-infra`](./2026-07-09-pocketbase-infra.md)), o app `apps/runes` precisa de login, sessão e proteção de rotas antes de qualquer CRUD (usuário ou todo) poder existir. Hoje `apps/runes` não tem nenhum conceito de usuário logado.
...
- Logout
- Gate genérico de "troca de senha obrigatória" (mecanismo de redirecionamento; a origem do flag é criada na spec [`pocketbase-user-crud`](./2026-07-09-pocketbase-user-crud.md))
...
| UI | `apps/runes/src/routes/change-password/+page.svelte` + `+page.server.ts` — placeholder mínimo nesta spec (form real de troca de senha é detalhado em [`pocketbase-user-crud`](./2026-07-09-pocketbase-user-crud.md)); aqui só garante que a rota existe e é alcançável durante o gate |
...
- Jira (após aprovação da spec): `docs/workflow/2026-07-09-pocketbase-auth.jira.md`
- Feature doc (pós-implementação): `docs/features/2026-07-09-pocketbase-auth.md`
- PR: `docs/workflow/2026-07-09-pocketbase-auth.pr.md`
- Depende de: [`pocketbase-infra`](./2026-07-09-pocketbase-infra.md)
- Specs relacionadas: [`pocketbase-user-crud`](./2026-07-09-pocketbase-user-crud.md), [`pocketbase-todo-sharing`](./2026-07-09-pocketbase-todo-sharing.md)
