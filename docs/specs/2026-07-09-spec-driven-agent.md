...
- Jira (após aprovação da spec): `docs/workflow/2026-07-09-spec-driven-agent.jira.md`
- Feature doc (pós-implementação): `docs/features/2026-07-09-spec-driven-agent.md`
- PR: `docs/workflow/2026-07-09-spec-driven-agent.pr.md`
