...
> `docs/features/2026-07-10-e2e-test-fix-plan.md`. Este documento manteve o plano original; os pontos
...
`getByTestId` conforme a spec `docs/specs/2026-07-10-data-testid-e2e.md`.
...
- Spec: `docs/specs/2026-07-10-e2e-test-fix-plan.md`
- Spec data-testid: `docs/specs/2026-07-10-data-testid-e2e.md`
- Feature doc (pós-implementação): `docs/features/2026-07-10-e2e-test-fix-plan.md`
- PR: `docs/workflow/2026-07-10-e2e-test-fix-plan.pr.md`
