...
## Links
- Jira (após aprovação da spec): `docs/workflow/2026-07-12-kanban.jira.md`
- Feature doc (pós-implementação): `docs/features/2026-07-12-kanban.md`
- PR: `docs/workflow/2026-07-12-kanban.pr.md`
- Depende de: [`pocketbase-auth`](./2026-07-09-pocketbase-auth.md), [`pocketbase-user-crud`](./2026-07-09-pocketbase-user-crud.md)
- Specs relacionadas: [`planning-poker`](./2026-07-12-planning-poker.md) (exporta tasks votadas para este Kanban)
