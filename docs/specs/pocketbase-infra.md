...
- Integração do SvelteKit com o PocketBase (spec [`pocketbase-auth`](./pocketbase-auth.md))
- Telas de CRUD de usuário (spec [`pocketbase-user-crud`](./pocketbase-user-crud.md))
- Coleções de todo (spec [`pocketbase-todo-sharing`](./pocketbase-todo-sharing.md))
...
- Jira (após aprovação da spec): `docs/workflow/pocketbase-infra.jira.md`
- Feature doc (pós-implementação): `docs/features/pocketbase-infra.md`
- PR: `docs/workflow/pocketbase-infra.pr.md`
- Specs relacionadas: [`pocketbase-auth`](./pocketbase-auth.md), [`pocketbase-user-crud`](./pocketbase-user-crud.md), [`pocketbase-todo-sharing`](./pocketbase-todo-sharing.md)
