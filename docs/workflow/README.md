...
| `chat-realtime` | _(pendente)_ | [chat-realtime.jira.md](./chat-realtime.jira.md) |
| `chat-notifications` | _(pendente)_ | [chat-notifications.jira.md](./chat-notifications.jira.md) |
