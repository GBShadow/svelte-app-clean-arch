...
- Spec: [docs/specs/chat-realtime.md](../specs/chat-realtime.md)
- Feature: [docs/features/chat-realtime.md](../features/chat-realtime.md)
...
- Closes #[issue]
- Jira: [JIRA-KEY] — [docs/workflow/chat-realtime.jira.md](./chat-realtime.jira.md)
