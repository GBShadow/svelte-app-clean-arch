...
- Spec: [docs/specs/e2e-test-fix-plan.md](../specs/e2e-test-fix-plan.md)
- Feature: [docs/features/e2e-test-fix-plan.md](../features/e2e-test-fix-plan.md)
...
- Jira: [docs/workflow/e2e-test-fix-plan.jira.md](./e2e-test-fix-plan.jira.md)
