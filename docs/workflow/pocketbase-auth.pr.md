...
- Spec: [docs/specs/pocketbase-auth.md](../specs/pocketbase-auth.md)
- Feature: [docs/features/pocketbase-auth.md](../features/pocketbase-auth.md)
...
- Closes #[issue]
- Jira: [JIRA-KEY] — [docs/workflow/pocketbase-auth.jira.md](./pocketbase-auth.jira.md)
