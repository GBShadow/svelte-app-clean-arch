...
- Spec: [docs/specs/pocketbase-infra.md](../specs/pocketbase-infra.md)
- Feature: [docs/features/pocketbase-infra.md](../features/pocketbase-infra.md)
...
- Closes #[issue]
- Jira: [JIRA-KEY] — [docs/workflow/pocketbase-infra.jira.md](./pocketbase-infra.jira.md)
