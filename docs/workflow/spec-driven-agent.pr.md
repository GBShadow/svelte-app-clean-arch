...
- `docs/specs/spec-driven-agent.md` (spec)
- `docs/workflow/spec-driven-agent.jira.md` (Jira draft)
- `docs/features/spec-driven-agent.md` (feature doc)
...
- Spec: [docs/specs/spec-driven-agent.md](../specs/spec-driven-agent.md)
- Feature: [docs/features/spec-driven-agent.md](../features/spec-driven-agent.md)
...
- Closes #[issue]
- Jira: [JIRA-KEY] — [docs/workflow/spec-driven-agent.jira.md](./spec-driven-agent.jira.md)
